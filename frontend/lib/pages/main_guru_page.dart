    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBarTheme(
        ...
        child: NavigationBar(
          ...
          indicatorColor: const Color(0xFFC8F6E6),
          destinations: const [
            NavigationDestination(icon: Icon(Icons.grid_view_rounded), label: "Beranda"),
            NavigationDestination(icon: Icon(Icons.people_alt_outlined), selectedIcon: Icon(Icons.people_alt_rounded), label: "Rekap"),
            NavigationDestination(icon: Icon(Icons.receipt_long_outlined), selectedIcon: Icon(Icons.receipt_long), label: "Perizinan"),
